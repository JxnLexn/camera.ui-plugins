  ...
  private createCameraStorage(): DeviceStorage<CameraStorageValues> {
    return this.cameraDevice.createStorage<CameraStorageValues>([
      ...
      },
      {
        ...
        description: 'Match the source resolution to what HomeKit requests; off uses the primary source.',
        group: 'Advanced',
        defaultValue: true,
        store: true,
        onSet: async (state: boolean) => {
      ...
      },
      {
        ...
        description: 'Always transcode instead of copying the stream.',
        group: 'Advanced',
        defaultValue: false,
        store: true,
        onSet: async (state: boolean) => {
